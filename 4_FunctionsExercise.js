...
// 1. What mysteryFunction1 does 
  // it takes y = 4, plugs that into the mysteryFuction where y = 4 = p1. 4 is multipled by 2 and new value is assigned to z.
// 2. What prints out for the value of y = 4
// 3. What prints out for the value of z = 8
// Now run the code and see if you're correct.
// Were you correct? If not, what did you learn?
  // yes however i had doubts since y variable was declared after the function, i wasn't sure if it would be able to call on th variable.
...
// 1. What mysteryFunction2 does
  // takes two variablese, subtracts first 2nd var from 1st. assigns diff to var x and returns x
