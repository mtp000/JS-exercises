...
// EXERCISE 5.  
// In exercise 4, what are some of the unexpected cases wher  e `varA` and `varB`
...
// in the case where one var is a number and the other is a the samee number written as a string. 
// the string would be read as a number and type coercion would occur
...
// This was harder as I had to remember how to divide a number so i can see if there are remainders. 
//Checking the code was harder as well. Since freecoodecamp usually has the topics linked, i was able to read and check my code more readily whereas here I was using chrome developer tools.
